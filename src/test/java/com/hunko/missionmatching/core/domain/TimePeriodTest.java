...
class TimePeriodTest {
    ...
    @Test
    void 단위기간_생성_성공() {
        ZonedDateTime startDate = ZonedDateTime.of(2020, Month.JANUARY.getValue(), 1, 1, 0, 0, 0, ZoneId.systemDefault());
    ...
    void 단위기간_생성_실패() {
        ZonedDateTime startDate = ZonedDateTime.of(2020, Month.JANUARY.getValue(), 1, 1, 0, 0, 0, ZoneId.systemDefault());
        ZonedDateTime endDate = ZonedDateTime.of(2020, Month.JANUARY.getValue(), 1, 0, 59, 59, 0, ZoneId.systemDefault());
